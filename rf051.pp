...
uses crt,mycrt,mouse,wads,dos,fpgraph,grx,sprites,rfunit,timer,api,ports,go32;
...
begin
 ...
 repeat
   ...
   case menu(7,1,'') of
    ...
    5: begin loadgame(getsave('загрузить')); if loaded then break; end;
